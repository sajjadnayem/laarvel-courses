            ...
            <div>
                ...
                <ul class="mt-5">
                    @foreach($series as $item)
                        <li class="mb-2">
                            <a href="{{route('archive', ['series', $item->name])}}"
                               class="text-links text-gray-100 text-base before:text-gray-100">{{$item->name}}</a>
                        </li>
                    @endforeach
                </ul>
            </div>
            ...
            <div>
                ...
                <ul class="mt-5">
                    @foreach($platforms as $platform)
                        <li class="mb-2">
                            <a href="{{route('archive', ['platform', $platform->name])}}"
                               class="text-links text-gray-100 text-base before:text-gray-100">{{$platform->name}}</a>
                        </li>
                    @endforeach
                </ul>
            </div>
            <div>
                ...
                <ul class="mt-5">
                    @foreach($topics as $topic)
                        <li class="mb-2">
                            <a href="{{route('archive', ['topic', $topic->name])}}"
                               class="text-links text-gray-100 text-base before:text-gray-100">{{$topic->name}}</a>
                        </li>
                    @endforeach
                </ul>
            </div>
