            ...
            <section aria-labelledby="courses-heading" class="pt-6 pb-12">
                ...
                <div class="flex gap-x-8 gap-y-10">
                    ...
                    <form id="filter-courses" class="w-3/12 block bg-white p-4 px-6 shadow rounded-sm" method="GET">
                            ...
                            <div class="pt-6">
                                <div class="space-y-2">
                                    @foreach($levels as $level)
                                        <div class="flex items-center">
                                            <input name="level" onchange="this.form.submit()" id="filter-level-{{$level->name}}" @if(array_key_exists('level', $_GET) && $_GET['level'] ==$level->id) checked @endif value="{{$level->id}}" type="checkbox"
                                                   class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500 form-submit">
                                            <label for="filter-level-{{$level->name}}" class="ml-3 text-sm text-gray-600"> {{$level->name}}
                                                <span class="text-xs text-gray-500">({{count($level->courses)}})</span>
                                            </label>
                                        </div>
                                    @endforeach
                                </div>
                        ...
                        !-- script code for select level start... -->
                        <script>
                        ...
                        !-- script code for select level end... -->
                                ...
                                <div class="space-y-2">
                                    <div class="flex items-center">
                                        <input onchange="this.form.submit()"
                                               @if(array_key_exists('duration', $_GET) && $_GET['duration'] === 0) checked @endif id="filter-duration-1h-5h" name="duration" value="0" type="checkbox"
                                               class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500">
                                    ...
                                    <div class="flex items-center">
                                        <input onchange="this.form.submit()"
                                               @if(array_key_exists('duration', $_GET) && $_GET['duration'] === 1) checked @endif id="filter-duration-5h-10h" name="duration" value="1" type="checkbox"
                                               class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500">
                                        <label for="filter-duration-5h-10h" class="ml-3 text-sm text-gray-600"> 5-10
                                            hours <span class="text-xs text-gray-500">{{$fiveToTen}}</span>
                                        </label>
                                    </div>
                                    <div class="flex items-center">
                                        <input onchange="this.form.submit()" @if(array_key_exists('duration', $_GET) && $_GET['duration'] === 2) checked @endif   id="filter-duration-10h+" name="duration" value="2" type="checkbox"
                                               class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500">
                        ...
                        !-- script for handle duration start... -->
                        <script>
                        ...
                        !-- script for handle duration finish... -->
                            ...
                            <li class="bg-white px-4 py-6 shadow rounded-sm">
                                <div class="flex justify-center">
                                    <div class="min-w-fit mx-auto">
                                        <img class="inline-block w-10 rounded-full" src="{{$course->image}}"  alt="{{$course->title}}">
                                    </div>
                                    <div class="w-10/12">
                                        <div class="flex">
                                            <div class="flex-1 overflow-flex-wrap">
                                                ...
                                                <div class="flex items-center gap-3">
                                                    ...
                                                    <a href="#reviews" class="text-sm text-gray-500"> {{count($course->reviews)}} Review{{count($course->reviews) > 1 ? 's' : ''}} </a>                                                </div>
                                            </div>
                                        </div>
                                        <div class="mt-4 space-y-1 text-sm text-gray-700 line-clamp-5">
                                            @php
                                            // spilit the paragraph into array of lines
                                            $lines = explode("\n", $course->description);
