                    ...
                    @foreach($series as $item)
                        <li class="w-full lg:max-w-[165px]">
                            <a href="#" class="bg-white border mx-auto border-orange box-shadow w-full rounded-lg flex items-center justify-center">
                                <img src="{{$item->image}}" alt="{{$item->name}}" class="w-20 md:w-auto h-auto object-cover">
                            </a>
                        </li>
                    @endforeach
                </ul>
            ...
            <section class="mt-20 lg:mt-[140px]">
                ...
                <div class="max-w-7xl w-full inline-flex single-feature gap-10 flex-wrap mx-auto">
                    ...
                    <div class="bg-white rounded grap-10 overflow-hidden shadow-card">
                        <a href="single.html">
                            <img src ="{{$course->image}}" alt="Laravel" class="w-full h-auto object-contain">
                        </a>
                        <div class="px-6 pb-5">
                            ...
                            <div>
                                <div class="flex items-center mb-2">
                                    <div class="flex items-center">
                                        <img src="https://laravel-courses.com/storage/thumbnails/default/56/tp/g7t7058gcgwk00s48cwww.png?p=authors%2Fa489f89a-4866-4c10-961f-5fa6526d9709.png&amp;s=pd&amp;smartcrop=28x28" alt="" class="w-7 h-7 object-contain flex shrink-0 rounded-full">
                                    </div>
                                    <h4 class="text-sm-primary w-full leading-5 ml-2"> {{$course->submiitedBy->name}} </h4>
                                </div>
                                <div class="mt-3">
